...
So, I did it.
[I went to Prom.](http://www.lastcoolnameleft.com/modules.php?set_albumName=austin_lindy_prom_2004&op=modload&name=gallery&file=index&include=view_album.php&page=1)
But this time, I could dance.

--SnoopyKiss wants to give props, where props are due:  Thanks [Hannah](http://www.lastcoolnameleft.com/modules.php?set_albumName=austin_lindy_prom_2004&id=IMG_0023&op=modload&name=gallery&file=index&include=view_photo.php), for starting this, Clint for hosting myself and Heather, and Nate and all others for organizing this great weekend!